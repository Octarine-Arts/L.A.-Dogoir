...
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class UINavigation : PointerInputModule
    {
        ...
        [Obsolete ("forceModuleActive has been deprecated. There is no need to force the module awake as UINavigation works for all platforms")]
